#ifndef CAFFE_MEX_LAYER_HPP_
#define CAFFE_MEX_LAYER_HPP_
...
class MEXLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  Dtype maximum_entropy_regularization_coeff_;
